...
describe('v2 subscriber-suspend route', () => {
  ...
  it('maps missing, inactive, and idempotency conflicts to 409', async () => {
    const subscriberCommands: SubscriberCommandRepository = {
      ...
      suspend: async () => { throw new Error('SUBSCRIBER_NOT_ACTIVE'); }, cancel: async () => { throw new Error('unused'); }, delete: async () => { throw new Error('unused'); }
    };
