...
**Next implementation order:** (1) v2 authentication middleware and CORS; (2) guarded Railway preview deployment under `/api/v2`; (3) one Cloudflare preview read feature; (4) authenticated end-to-end smoke tests; (5) transactional lifecycle commands; (6) shadow comparison; (7) progressive cutover; (8) legacy retirement.
