...
**Next implementation order:** (1) controlled Railway preview deployment under `/api/v2`; (2) one Cloudflare preview read feature; (3) authenticated end-to-end smoke tests; (4) transactional lifecycle commands; (5) shadow comparison; (6) progressive cutover; (7) legacy retirement.
