...
**Latest implementation commit:** `9276bd1 feat: persist guarded projection state in firestore`, following the corrected garage-summary adapter in `4cc13b1`. The full emulator-backed v2 check passes locally with 49 test files and 267 tests. Do not infer the new Production Gate result until it completes.
