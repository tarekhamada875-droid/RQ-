...
**Next implementation order:** (1) production telemetry sink and explicit route budgets; (2) controlled Railway preview deployment under `/api/v2`; (3) one Cloudflare preview read feature; (4) authenticated end-to-end smoke tests; (5) transactional lifecycle commands; (6) shadow comparison; (7) progressive cutover; (8) legacy retirement.
